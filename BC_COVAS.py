...
malignant_COVAS = COVA_scoring_dict['malignant'][0]
malignant_COVA_matrix = COVA_scoring_dict['malignant'][2]
   
benign_COVAS = COVA_scoring_dict['benign'][0]
benign_COVA_matrix = COVA_scoring_dict['benign'][2]
